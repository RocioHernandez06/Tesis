...
\textbf{configuración de infraestructura} del sistema logístico. Este
vector pertenece al conjunto discreto \(\{0,1\}^m\), que es no convexo,
finito y tiene cardinalidad \(2^m\).
...
almacenes candidatos a zonas de demanda}, y pertenece a un espacio
...
\tightlist
\item
  que la demanda en cada zona \(j \in \mathcal{J}\) sea satisfecha y
\item
...
de zonas de demanda \(\mathcal{J}\), y los parámetros exógenos
