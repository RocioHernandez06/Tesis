...
\(Q \geq 1\)}{Formulación del problema de optimización: minimización de f(Q) sujeto a Q \textbackslash geq 1}}\label{formulaciuxf3n-del-problema-de-optimizaciuxf3n-minimizaciuxf3n-de-fq-sujeto-a-q-geq-1}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{chapters/metodos_files/figure-pdf/cell-2-output-1.pdf}}
...
\quad \text{sujeto a} \quad Q \ge \mathbf{1}
}\end{equation}
