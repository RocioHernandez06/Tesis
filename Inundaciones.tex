...
\item
  \(\mathcal{L}\) es compacto Sección~\ref{sec-compacto},
\end{enumerate}
...
\item
  ...
  \(\nabla^2 f\) es Lipschitz-continuo Sección~\ref{sec-funcion_CD} en
  una vecindad de un minimizador \(x^\star\), y la búsqueda lineal
  satisface las condiciones de Wolfe, entonces la sucesión \(\{x_k\}\)
  cumple
...
\item
  ...
  a lo sumo \(n\) pasos, generando direcciones conjugadas
...
Sección~\ref{sec-convergenciasuperlineal} del método BFGS para funciones
cuadráticas. Este comportamiento se mantiene en problemas no cuadráticos
siempre que el condicionamiento sea razonable y la búsqueda lineal sea
...
convexa Sección~\ref{sec-funcion_CD}, cualquier método de la familia
restringida de Broyden converge en a lo sumo \(n\) pasos, generando
direcciones conjugadas Sección~\ref{sec-funcion_CD} respecto al Hessiano
...
\item
  ...
  como se establece en Fletcher (1987), Sección 3.4.
\end{itemize}
...
\item
  ...
  (Sección~\ref{sec-funcion_CD}) con constante 1}, lo que implica
...
Hessiano como se presenta en Nocedal y Wright (2006), Sección 7.2.
...
Sección~\ref{sec-funcion_CD}, tal como se analiza en Liu y Nocedal
(1989), Sección 4.
...
\textbf{rapidez de convergencia} Sección~\ref{sec-funcion_CD} y
