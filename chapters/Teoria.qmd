...
## Introducción al problema integrado de localización e inventario {#sec-sec-problemas}
...
En la @ec-formulacion se formuló el problema de optimización unidimensional como:
...
Agrupando los términos proporcionales a $1/Q$, reescribimos la parte no constante de la ecuación (@eq-Z(q)) como:
