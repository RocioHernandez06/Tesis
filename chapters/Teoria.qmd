...
> La función $Z(Q)$ definida en @sec-ZEOQ es diferenciable en $(0,\infty)$, pero no es convexa globalmente (@sec-funcion_CD) si $\beta>0$ y $\sigma_L>0$.  
