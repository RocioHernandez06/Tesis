...
> **Teorema 6.2 (Convergencia global de L-BFGS-B).**  {#eq-teorema62}
...
Bajo estas condiciones, el problema @q-min_Q_restriccion admite un **único minimizador global** $Q^* \ge \mathbf{1}$.  
...
> Supóngase que el problema @eq-eq-min_Q_restriccion satisface (M1)–(M3), y que el minimizador único $Q^*$ verifica $Q^* > \mathbf{1}$.  
...
Por tanto, se satisfacen las hipótesis del **Teorema @eq-teorema62**  de la @sec-convregencia_global, de donde resulta
