...
en \((0,\infty)\). Su curvatura depende de \(\sigma_L\):
\end{quote}
...
\tightlist
\item
  Si \(\sigma_L = \sigma_L(Q)\) depende de \(Q\): la segunda derivada
  incluye términos adicionales que pueden cambiar de signo, y \(Z(Q)\)
  puede perder convexidad global.
\end{itemize}
\end{quote}
